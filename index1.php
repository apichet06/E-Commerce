  ...
  <div class="ps-product-list ps-new-arrivals">
    <div class="ps-container">
      <div class="ps-section__content">
        ...
        <!-- #                          Products                            # -->
        <!-- ################################################################ -->
        <?php $sql0 = mysqli_query($conn,"SELECT a.cat_id,a.CAT_Name1,b.pic1,b.pd_name1,b.pd_name2,b.pd_price,b.pd_pricesell,b.pd_id,b.pd_discount  FROM category_db a 
          INNER JOIN product_db b 
          on a.cat_id = b.cat_id 
          order by b.cat_id asc "); 
        $old = "";
        ...
        while ($rs = mysqli_fetch_assoc($sql0)) {
         ...
         if ($old !== $rs['cat_id']) {  
          if($old !=""){   ?>
            ...
            <?php } ?>
            <div class="ps-product-list ps-garden-kitchen" id="<?=$rs['cat_id'];?>">
              <div class="ps-container">
                <div class="ps-section__header">
                  <h3> <?=$rs['CAT_Name1']?></h3>
                  <ul class="ps-section__links">              
                    <li><a href="shop_allproduct.php?id=<?=$rs['cat_id']?>">View All </a></li>
                  </ul>
                </div>
                <div class="ps-section__content">
